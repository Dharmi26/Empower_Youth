...
const About = () => {
  ...
  return (
    <div className='min-h-screen bg-bg1 bg-fixed mb-36'>
        <div className='bg-blue-100 bg-opacity-50 h-full flex flex-col gap-10 justify-center items-center px-48 py-28'>
            <h1 className='text-navblue text-4xl font-bold'>About</h1>
            <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" className='text-lg text-justify text-navblue'>
