...
const Clients = () => {
  ...
  return (
    <div className='flex flex-col gap-20 justify-center items-center h-full px-6 py-12 sm:px-12 md:px-36 lg:px-48 sm:py-20 md:py-24 lg:py-32'>
      <h1 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100" data-aos-anchor-placement="center-bottom" className='text-navblue text-4xl font-semibold uppercase'>Our Clients</h1>
