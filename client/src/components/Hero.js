...
const Hero = () => {
  ...
  return (
    <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100" data-aos-anchor-placement="center-bottom" className='relative z-0'>
